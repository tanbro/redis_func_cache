...
- Support multiple serialization formats: JSON, Pickle, MsgPack, YAML, BSON, CBOR ...
...
- The Redis keys generated by *Multiple* policies include a hash derived from Python bytecode, making them incompatible across Python versions. Additionally, the decorator cannot be used with native/built-in functions or Cython implementations due to same limitations.
